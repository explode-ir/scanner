...
puts "
  ...
  ________   _______  _      ____  _____  ______   _______ __  __  
 |  ____\ \ / /  __ \| |    / __ \|  __ \|  ____| |__   __|  \/  | 
 | |__   \ V /| |__) | |   | |  | | |  | | |__       | |  | \  / | 
 |  __|   > < |  ___/| |   | |  | | |  | |  __|      | |  | |\/| | 
 | |____ / . \| |    | |___| |__| | |__| | |____     | |  | |  | | 
 |______/_/ \_\_|    |______\____/|_____/|______|    |_|  |_|  |_| 
...
puts "[uptd] Update explode scanner".green
puts "[anon] Run Anonymous Mode".green
puts "[info] About explode scanner".green
puts
end
if $option == "anon" then 
puts
...
if $option == "info" then
    puts "
You Can use this tool to Spider your website and get important information and gather information automaticaly using whatweb-host-traceroute-dig-fierce-wafw00f or to Identify the cms and to find the vulnerability in your website using Cms Exploit Scanner && WebApp Vul Scanner Also You can use explode scanner to Scan automaticly multiple type of scan with nmap and unicorn . And With this tool You can Generate PHP Simple Backdoors upload it manual and connect to the target using explode scanner
...
if $option == "uptd" then 
system("git clone https://github.com/explode-ir/scanner.git")
end
if $option == "site" then
                   ...
                   if $web == "3" then
                    ...
                    system("cls")
                            puts " 
                              ...
                              ________   _______  _      ____  _____  ______  __          ________ ____  
 |  ____\ \ / /  __ \| |    / __ \|  __ \|  ____| \ \        / /  ____|  _ \ 
 | |__   \ V /| |__) | |   | |  | | |  | | |__     \ \  /\  / /| |__  | |_) |
 |  __|   > < |  ___/| |   | |  | | |  | |  __|     \ \/  \/ / |  __| |  _ < 
 | |____ / . \| |    | |___| |__| | |__| | |____     \  /\  /  | |____| |_) |
 |______/_/ \_\_|    |______\____/|_____/|______|     \/  \/   |______|____/ 
